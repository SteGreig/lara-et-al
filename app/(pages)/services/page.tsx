  ...
  return (
    <main>
      ...
      <article className="mt-16">
        {services && services.map((service: ServiceType, i: number) => (

          <details key={i} className="border-t last:border-b border-primary container">
            <summary className="text-3xl cursor-pointer py-4"><h2>{service.title}</h2></summary>
